defmodule MP3NameCleanerTest do
  ...
  test "simulate" do
    ...
    assert "Alice In Chains - Would.mp3" == Map.get(map, "Alice In Chains - Would-1992.mp3")
    ...
    assert "Guy - Let's Chill.mp3" == Map.get(map, "Guy - Let's Chill-1990.mp3")
    ...
    assert "Julieta Venegas - Lento.mp3" == Map.get(map, "Julieta Venegas - Lento-2003.mp3")
    ...
    assert "Toto - Africa.mp3" == Map.get(map, "Toto - Africa-1982.mp3")

    assert "Toto - Rosanna.mp3" == Map.get(map, "Toto - Rosanna-1982.mp3")

    assert "Malo - Suavecito.mp3" == Map.get(map, "MALO - SUAVECITO -LIVE AUDIENCE - 1972.mp3")
  end
